...
local function InitCreditsPanel()
    ...
    local credits_data = {
        ...
        },
        {
            ...
            items = {"NH2COOP.Credits.Team.Hen", "NH2COOP.Credits.Team.Harry"},
        },
        {
            kind = "TwoColumns",
            duration = 7,
            items = {"NH2COOP.Credits.Team.Carlos", "NH2COOP.Credits.Team.Christopher"},
        },
        {
            kind = "TwoColumns",
            duration = 7,
            items = {"NH2COOP.Credits.Team.Viktor", "NH2COOP.Credits.Team.Pedro"},
        },
        {
            kind = "TwoColumns",
            duration = 7,
            items = {"NH2COOP.Credits.Team.Damon", "NH2COOP.Credits.Team.Yoav"},
        },
        {
            kind = "TwoColumns",
            duration = 7,
            items = {"NH2COOP.Credits.Team.Aidin", "NH2COOP.Credits.Team.Joel"},
        },
        {
            kind = "TwoColumns",
            duration = 7,
            items = {"NH2COOP.Credits.Team.David", "NH2COOP.Credits.Team.Daniele"},
        },
        {
            kind = "CenterText",
            duration = 5,
